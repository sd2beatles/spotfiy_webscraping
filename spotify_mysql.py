    ...
    def set_artists(self,cursor):
        ...
        for artist in self.artists:
            try:
                ...
                print("Somehting unexcpted issue has arisen when searching infomration on {}".format(info['name']))
                continue
...
def main():
    ...
    artists=["BTS","Taylor Swift","The Weeknd","Christine and the Queens","Bob Dylan","Cardi"]
